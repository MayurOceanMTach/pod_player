...
// Set volume between 0.0 - 1.0,
  ...
  Future<void> enableFullScreen(String tag, bool hideControls) async {
    ...
    if (!isFullScreen) {
      ...
      _enableFullScreenView(tag, hideControls);
      isFullScreen = true;
  ...
  void _enableFullScreenView(String tag, bool hideControls) {
    if (!isFullScreen) {
